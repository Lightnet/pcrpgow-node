/*
 PlayCanvas Engine v0.181.10 revision c013b0c
 http://playcanvas.com
...
*/
var pc={version:"0.181.10",revision:"c013b0c",config:{},common:{},apps:{},data:{},unpack:function(){console.warn("pc.unpack has been deprecated and will be removed shortly. Please update your code.")},makeArray:function(f){var a,b=[],d=f.length;for(a=0;a<d;++a)b.push(f[a]);return b},type:function(f){if(null===f)return"null";var a=typeof f;return"undefined"==a||"number"==a||"string"==a||"boolean"==a?a:_typeLookup[Object.prototype.toString.call(f)]},extend:function(f,a){var b,d;
...
this._skyboxPrefiltered4=this._skyboxPrefiltered8=this._skyboxPrefiltered16=this._skyboxPrefiltered32=this._skyboxPrefiltered64=this._skyboxPrefiltered128=null};f.prototype.update=function(){for(var a=0,b=this._models.length;a<b;a++)this._models[a].getGraph().syncHierarchy()};f.prototype.destroy=function(){var a,b=this.getModels();for(a=0;a<b.length;a++)this.removeModel(b[a]);for(a=0;a<this._lights.length;a++)this.removeLight(this._lights[a]);this.skybox=null};return{Scene:f}}());pc.extend(pc,function(){function f(a,b){return a.distSqr&&b.distSqr?b.distSqr-a.distSqr:b.key-a.key}function a(a){var b=Array(a),a=function(a){return b[a]};a.size=0;a.push=function(a){b[this.size]=a;++this.size};a.data=b;return a}function b(a,b,d){b=new pc.Texture(a,{format:pc.PIXELFORMAT_R8_G8_B8_A8,width:b,height:d,autoMipmap:!1});b.minFilter=pc.FILTER_NEAREST;b.magFilter=pc.FILTER_NEAREST;b.addressU=pc.ADDRESS_CLAMP_TO_EDGE;b.addressV=pc.ADDRESS_CLAMP_TO_EDGE;return new pc.RenderTarget(a,b,!0)}
function d(a,b){var d=new pc.Texture(a,{format:pc.PIXELFORMAT_R8_G8_B8_A8,width:b,height:b,cubemap:!0,autoMipmap:!1});d.minFilter=pc.FILTER_NEAREST;d.magFilter=pc.FILTER_NEAREST;d.addressU=pc.ADDRESS_CLAMP_TO_EDGE;d.addressV=pc.ADDRESS_CLAMP_TO_EDGE;for(var e=[],g=0;6>g;g++){var f=new pc.RenderTarget(a,d,{face:g,depth:!0});e.push(f)}return e}function e(a,e){var g;e.getType()===pc.LIGHTTYPE_POINT?(e._cacheShadowMap?(g=C[e._shadowResolution],g||(g=d(a,e._shadowResolution),C[e._shadowResolution]=g)):
g=d(a,e._shadowResolution),e._shadowCamera.setRenderTarget(g[0]),e._shadowCubeMap=g):(e._cacheShadowMap?(g=A[e._shadowResolution],g||(g=b(a,e._shadowResolution,e._shadowResolution),A[e._shadowResolution]=g)):g=b(a,e._shadowResolution,e._shadowResolution),e._shadowCamera.setRenderTarget(g))}function g(a){this.device=a;this._cullTime=this._shadowMapUpdates=this._materialSwitches=this._camerasRendered=this._removedByInstancing=this._immediateRendered=this._instancedDrawCalls=this._skinDrawCalls=this._forwardDrawCalls=
this._shadowDrawCalls=this._depthDrawCalls=0;a=this.device.getProgramLibrary();this._depthShaderStatic=a.getProgram("depth",{skin:!1});this._depthShaderSkin=a.getProgram("depth",{skin:!0});this._depthProgStatic=[];this._depthProgSkin=[];this._depthProgStaticOp=[];this._depthProgSkinOp=[];this._depthProgStaticPoint=[];this._depthProgSkinPoint=[];this._depthProgStaticOpPoint=[];this._depthProgSkinOpPoint=[];for(var b=["r","g","b","a"],d=0;d<pc.SHADOW_DEPTH+1;d++){this._depthProgStatic[d]=a.getProgram("depthrgba",
{skin:!1,opacityMap:!1,shadowType:d});this._depthProgSkin[d]=a.getProgram("depthrgba",{skin:!0,opacityMap:!1,shadowType:d});this._depthProgStaticPoint[d]=a.getProgram("depthrgba",{skin:!1,opacityMap:!1,point:!0});this._depthProgSkinPoint[d]=a.getProgram("depthrgba",{skin:!0,opacityMap:!1,point:!0});this._depthProgStaticOp[d]={};this._depthProgSkinOp[d]={};this._depthProgStaticOpPoint[d]={};this._depthProgSkinOpPoint[d]={};for(var e=0;4>e;e++)this._depthProgStaticOp[d][b[e]]=a.getProgram("depthrgba",
{skin:!1,opacityMap:!0,shadowType:d,opacityChannel:b[e]}),this._depthProgSkinOp[d][b[e]]=a.getProgram("depthrgba",{skin:!0,opacityMap:!0,shadowType:d,opacityChannel:b[e]}),this._depthProgStaticOpPoint[d][b[e]]=a.getProgram("depthrgba",{skin:!1,opacityMap:!0,point:!0,opacityChannel:b[e]}),this._depthProgSkinOpPoint[d][b[e]]=a.getProgram("depthrgba",{skin:!0,opacityMap:!0,point:!0,opacityChannel:b[e]})}a=this.device.scope;this.projId=a.resolve("matrix_projection");this.viewId=a.resolve("matrix_view");
this.viewId3=a.resolve("matrix_view3");this.viewInvId=a.resolve("matrix_viewInverse");this.viewProjId=a.resolve("matrix_viewProjection");this.viewPosId=a.resolve("view_position");this.nearClipId=a.resolve("camera_near");this.farClipId=a.resolve("camera_far");this.lightRadiusId=a.resolve("light_radius");this.fogColorId=a.resolve("fog_color");this.fogStartId=a.resolve("fog_start");this.fogEndId=a.resolve("fog_end");this.fogDensityId=a.resolve("fog_density");this.modelMatrixId=a.resolve("matrix_model");
...
0;for(G=a._localLights[1].length=0;G<L.length;G++)E=L[G],E.getEnabled()&&(E.getType()===pc.LIGHTTYPE_DIRECTIONAL?a._globalLights.push(E):a._localLights[E.getType()===pc.LIGHTTYPE_POINT?0:1].push(E));var Z=[],S;R=pc.now();this.updateCameraFrustum(b);for(G=0;G<ea;G++)E=m[G],E.skinInstance&&E.skinInstance.updateMatrices();var ca=b._node.getPosition();for(G=0;G<ea;G++){E=m[G];d=!0;y=null;if(!E.command){if(E._hidden)continue;e=E;if(e.layer===pc.LAYER_WORLD&&(b.frustumCulling&&E.cull&&(d=this._isVisible(b,
e)),d))if(S=e.material.blendType,S!==pc.BLEND_NONE){y||(y=e.aabb.center);S=y.x-ca.x;var ia=y.y-ca.y;N=y.z-ca.z;e.distSqr=S*S+ia*ia+N*N}else void 0!==e.distSqr&&delete e.distSqr}d&&Z.push(E)}this._cullTime+=pc.now()-R;for(G=0;G<a.immediateDrawCalls.length;G++)Z.push(a.immediateDrawCalls[G]);this._immediateRendered+=a.immediateDrawCalls.length;m=Z;ea=Z.length;for(G=0;G<ea;G++)E=m[G],E.skinInstance&&E.skinInstance.updateMatrixPalette();m.sort(f);if(b._renderDepthRequests){E=b._rect;G=Math.floor(E.width*
